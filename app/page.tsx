...
import { ArrowRight, Building, Map, Search } from "lucide-react"
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <section className="py-12 bg-black">
        <div className="container px-4 md:px-6 mx-auto">
          <form action="/search" method="get" className="flex flex-col md:flex-row gap-4 max-w-3xl mx-auto">
            <Input
              name="q"
                ...
                <div className="bg-gray-900 rounded-lg overflow-hidden transition-transform duration-300 group-hover:translate-y-[-8px]">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-400 mb-4">
                      ...
                      {building === "SMV" && "S.M. Viswanathan Building"}
                    </p>
